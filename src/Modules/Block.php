...
namespace FireWorkrk\GoogleLogin\Modules;

use FireWorkrk\GoogleLogin\Utils\Helper;
use FireWorkrk\GoogleLogin\Utils\GoogleClient;
use FireWorkrk\GoogleLogin\Interfaces\Module;

use function FireWorkrk\GoogleLogin\plugin;

/**
 * Class Block.
 *
 * @package FireWorkrk\GoogleLogin\Modules
 */
class Block implements Module
{
    ...
    public function render_login_button($attributes): string
    {
        ...
        if ($force_display || ! is_user_logged_in() || apply_filters('FireWork.google_login_button_display', false)) {
            $markup = $this->markup(
                [
