...
namespace FireWork\GoogleLogin\Modules;
...
use function FireWork\GoogleLogin\plugin;

/**
 * Class Login.
 *
 * @package FireWork\GoogleLogin\Modules
 */
class Login implements ModuleInterface {
	...
	public function init(): void {
		...
		add_action( 'FireWork.google_register_user', [ $this->authenticator, 'register' ] );
		add_action( 'FireWork.google_redirect_url', [ $this, 'redirect_url' ] );
		add_action( 'FireWork.google_user_created', [ $this, 'user_meta' ] );
		add_filter( 'FireWork.google_login_state', [ $this, 'state_redirect' ] );
	...
	public function authenticate( $user = null ) {
		...
		try {
			...
			if ( $user instanceof WP_User ) {
				 ...
				 */
				do_action( 'FireWork.google_user_authenticated', $user );
	...
	public function state_redirect( array $state ): array {
		 ...
		 */
		$state['redirect_to'] = $redirect_to ?? apply_filters( 'FireWork.google_default_redirect', admin_url() );
