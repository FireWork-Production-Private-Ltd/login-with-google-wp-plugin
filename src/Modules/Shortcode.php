...
class Shortcode implements ModuleInterface
{
    ...
    public function callback($attrs = []): string
    {
        ...
        add_filter('FireWorkrk.google_redirect_url', [ $this, 'redirect_url' ]);
        add_filter('FireWorkrk.google_login_state', [ $this, 'state_redirect' ]);

        $attrs['login_url'] = $this->gh_client->authorization_url();

        remove_filter('FireWorkrk.google_login_state', [ $this, 'state_redirect' ]);
        remove_filter('FireWorkrk.google_redirect_url', [ $this, 'redirect_url' ]);
