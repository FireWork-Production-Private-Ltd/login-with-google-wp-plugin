...
use WP_Mock;
use Mockery;
use FireWork\GoogleLogin\Modules\Shortcode as Testee;
 ...
 * Class ShortCodeTest
 *
 * @coversDefaultClass \FireWork\GoogleLogin\Modules\Shortcode
 *
...
class ShortCodeTest extends TestCase {
	...
	public function testCallbackWhenUserIsLoggedOut() {
		...
		WP_Mock::expectFilterAdded( 'FireWork.google_redirect_url', [ $this->testee, 'redirect_url' ] );
