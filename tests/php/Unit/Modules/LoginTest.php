...
use Exception;
use FireWork\GoogleLogin\Container;
use FireWork\GoogleLogin\Plugin;
use WP_Mock;
use Mockery;
use FireWork\GoogleLogin\Utils\Helper;
use FireWork\GoogleLogin\Utils\GoogleClient;
use FireWork\GoogleLogin\Modules\Settings;
use FireWork\GoogleLogin\Modules\Login as Testee;
use FireWork\GoogleLogin\Tests\TestCase;
use FireWork\GoogleLogin\Interfaces\Module as ModuleInterface;
use FireWork\GoogleLogin\Utils\Authenticator;

/**
 * Class LoginTest
 *
 * @coversDefaultClass \FireWork\GoogleLogin\Modules\Login
 *
...
class LoginTest extends TestCase {
	...
	public function testInit() {
		...
		WP_Mock::expectActionAdded( 'FireWork.google_register_user', [ $this->authenticatorMock, 'register' ] );
		WP_Mock::expectActionAdded( 'FireWork.google_redirect_url', [ $this->testee, 'redirect_url' ] );
		WP_Mock::expectActionAdded( 'FireWork.google_user_created', [ $this->testee, 'user_meta' ] );
		WP_Mock::expectFilterAdded( 'FireWork.google_login_state', [ $this->testee, 'state_redirect' ] );
	...
	public function testStateRedirectWithoutRedirectTo() {
		...
		WP_Mock::expectFilter( 'FireWork.google_default_redirect', 'https://example.com/login' );
		$state_data = $this->testee->state_redirect( [] );
		$this->assertIsArray( $state_data );
