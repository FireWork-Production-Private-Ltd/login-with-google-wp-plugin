...
namespace FireWork\GoogleLogin\Tests\Unit\Utils;

use WP_Mock;
use Exception;
use FireWork\GoogleLogin\Tests\TestCase;
use FireWork\GoogleLogin\Utils\GoogleClient as Testee;

/**
 * Class GoogleClientTest
 *
 * @coversDefaultClass \FireWork\GoogleLogin\Utils\GoogleClient
 *
 * @package FireWork\GoogleLogin\Tests\Unit\Utils
 */
class GoogleClientTest extends TestCase {
	...
	public function testCallWithOtherMethods() {
		WP_Mock::expectFilterNotAdded( 'FireWork.github_redirect_url', '' );
	...
	public function testSetAccessToken() {
		WP_Mock::expectFilter( 'FireWork.google_redirect_url', '' );
	...
	public function testAuthorizationURL() {
		...
		WP_Mock::onFilter( 'FireWork.google_scope' )->with( $scope )->reply( $scope );
		...
		WP_Mock::expectFilter( 'FireWork.google_client_args', $client_args );
