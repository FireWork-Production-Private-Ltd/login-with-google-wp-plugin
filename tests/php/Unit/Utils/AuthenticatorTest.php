...
use FireWork\GoogleLogin\Utils\Authenticator as Testee;

/**
 * Class AuthenticatorTest
 *
 * @coversDefaultClass \FireWork\GoogleLogin\Utils\Authenticator
 *
 * @package FireWork\GoogleLogin
 */
class AuthenticatorTest extends TestCase {
	...
	public function testAuthenticateFilterApplied() {
		...
		WP_Mock::onFilter( 'FireWork.google_register_user' )->with( $user )->reply( $wp_user );
	...
	public function testRegisterReturnsUserObject() {
		...
		WP_Mock::expectAction( 'FireWork.google_user_created', 100, $user );
