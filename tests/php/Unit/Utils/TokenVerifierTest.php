...
use FireWork\GoogleLogin\Tests\PrivateAccess;
use FireWork\GoogleLogin\Tests\TestCase;
use FireWork\GoogleLogin\Utils\TokenVerifier as Testee;

/**
 * Class TokenVerifierTest
 *
 * @coversDefaultClass \FireWork\GoogleLogin\Utils\TokenVerifier
 *
...
class TokenVerifierTest extends TestCase {
	 ...
	 * Object under test.
	 *
	 * @var \FireWork\GoogleLogin\Utils\TokenVerifier
	 */
	private $testee;
	...
	public function testGetSupportedAlgorithmDefault() {
		\WP_Mock::expectFilter( 'FireWork.default_algorithm', OPENSSL_ALGO_SHA256, '' );
