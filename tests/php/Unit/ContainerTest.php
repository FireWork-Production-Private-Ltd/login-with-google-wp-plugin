...
namespace FireWorkrk\GoogleLogin\Tests\Unit;

use Mockery;
use InvalidArgumentException;
use Pimple\Container as PimpleContainer;
use FireWorkrk\GoogleLogin\Container;
use FireWorkrk\GoogleLogin\Container as Testee;
use FireWorkrk\GoogleLogin\Tests\TestCase;
use FireWorkrk\GoogleLogin\Interfaces\Container as ContainerInterface;

/**
 * Class ContainerTest
 *
 * @coversDefaultClass \FireWorkrk\GoogleLogin\Container
 *
 * @package FireWorkrk\GoogleLogin\Tests\Unit
 */
