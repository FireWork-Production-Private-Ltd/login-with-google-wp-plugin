 ...
 * Class PluginTest
 *
 * @coversDefaultClass \FireWork\GoogleLogin\Plugin
 *
 * @package FireWork\GoogleLogin\Tests\Unit
 */
class PluginTest extends TestCase {
	...
	public function testHooksAddedOnRun() {
		...
		WP_Mock::expectFilter( 'FireWork.google_login_modules', $this->testee->active_modules );
